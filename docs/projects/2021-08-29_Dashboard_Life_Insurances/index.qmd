...
[{{< fa brands r-project >}} shiny dashboard](https://samanthacsik.shinyapps.io/strava_dashboard/){.btn target=_blank} [{{< fa brands github >}} source code](https://github.com/erikdeluca/Portafoglio-assicurazioni-vita){.btn target=_blank}
